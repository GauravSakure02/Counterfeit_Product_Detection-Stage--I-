		...
		{    	
	    	if(roll.equals("Admin"))
	    	{
	    		...
	    		else
	    		{
					...
					pw.println("");
					pw.println("</body></html>");
					response.sendRedirect("LoginPage.jsp?invalid");
	    		}
	    	}
	    	else if(roll.equals("Distribute"))
	    	{
	    		Connection con=DBconn.conn();
				 Statement st = (Statement) con.createStatement();
				    ResultSet rs;
				    String str="select * from companyregistertbl where Cemail='" + userid + "' and Cpassword='" + pwd + "'";
