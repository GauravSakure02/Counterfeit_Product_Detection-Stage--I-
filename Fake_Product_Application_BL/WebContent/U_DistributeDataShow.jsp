		 ...
		 <div >
		  <div  >
			...
			<%
					  try{
						  int i=1;
						  String query="select * from user_product_info_order where Status_Info='0'";
			...
			%>
				...
				<tr>
					...
					<td><%=rs.getString(8) %></td>
				 	<td> <a href="distributeaccept?id=<%=rs.getString(7)%>,<%=rs.getString(1)%>" style="background: yellow;color: black;">Accept</a> | 
